...
Route::prefix('/account')->middleware(AccountSubject::class)->group(function () {
    ...
    Route::get('/webauthn', [Client\WebauthnController::class, 'index'])->withoutMiddleware(RequireTwoFactorAuthentication::class);
    Route::get('/webauthn/register', [Client\WebauthnController::class, 'register'])->withoutMiddleware(RequireTwoFactorAuthentication::class);
    Route::post('/webauthn/register', [Client\WebauthnController::class, 'create'])->withoutMiddleware(RequireTwoFactorAuthentication::class);
    Route::delete('/webauthn/{id}', [Client\WebauthnController::class, 'deleteKey'])->withoutMiddleware(RequireTwoFactorAuthentication::class);
